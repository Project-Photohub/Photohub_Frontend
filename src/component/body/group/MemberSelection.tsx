...
export const MemberSelection = (props: MemberSelectionProps) => {
    return <div
        ...
        className={`${props.isSelected ? "bg-background-highlight" : "bg-background-hover hover:bg-background-highlight"} flex gap-[10px] rounded-[30px] h-[60px] pe-[20px] pl-[20px] pt-[10px] pb-[10px] animated`}
        onClick={() => {
